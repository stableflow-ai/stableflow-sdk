...
const BLOCKCHAIN_TO_CHAIN_ID: Partial<Record<TokenResponse.blockchain, number>> = {
...
export function getChainIdForTokenBlockchain(blockchain: TokenResponse.blockchain): number | undefined {
