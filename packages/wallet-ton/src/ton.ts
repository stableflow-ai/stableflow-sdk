...
export default class TonWallet {
  ...
  async quoteOFT(params: any) {
    ...
    this.csl("TonWallet quoteOFT", "red-600", "result.outputAmount: %o", result.outputAmount);
    this.csl("TonWallet quoteOFT", "red-600", "slippageTolerance: %o", slippageTolerance + "%");
    this.csl("TonWallet quoteOFT", "red-600", "Minimum received amount: %o", Big(amountWei).div(10 ** fromToken.decimals).times(Big(1).minus(Big(slippageTolerance || 0).div(100))).toFixed(6, 0));
